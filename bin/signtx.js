...
heirPubKey = "tpubDFYixx7sUg6yzmWuEsXVubgtvNMpAH9VWDyPkqfcyYF2LfpgjHz182wJn2CsFtwyMyaDdNaByp71ukf8dJ7yd45jrvNeD5aDdQ7Z2P4EHki"
aliceKey = Buffer ('03 d3 dd 37 df 76 41 57 f6 48 30 8d da c4 64 c5 95 64 59 75 48 4d a4 8b 7d c9 32 2c 5d f1 e2 cb 71')

function createRefreshOutputScript(aliceKey, bobKey) {
    alice = Buffer.from(aliceKey, 'hex')
  // aliceKey = "tpubDECZ14XEMYxMgF8BXmyJzcpX4AVmRiq4WSNaqgkArM6o5KhudPqNRYEyvRnyvdv1zKb9oq1V8fcQJpN4JVdGEaS5iLDKdp9fuk8B8Gh7Jmr";
  // aliceKey = Buffer ('03 d3 dd 37 df 76 41 57 f6 48 30 8d da c4 64 c5 95 64 59 75 48 4d a4 8b 7d c9 32 2c 5d f1 e2 cb 71')
...
async function createTransaction(
  ...
  alicePrivKey = "tprv8ZgxMBicQKsPfGA6KhKTv3wrhf4TVj8P6aP1NgNB4hREWSpNmm1XetAT4ScVBMdMNpa5dysWyJCA8EW3aXJtAfg37kbS7duU7b6QwkqB2st";
  ...
  const alice = wif.encode(239, aliceKey, false)
...
function csvGetFinalScripts(
    ...
    input = "993d63b34afeca3dd60404eb3ae8d346260b96cbfa15d86312fd1feeffa190a2:1"
    // input = "tb1qyuty90t4dgr4v8elhpsh2z8jg6zy57h37yc573"
    inputIndex = 0
    // scriptHash = Buffer.from('TCEhAwYoUrYdtleFWEJ01g8nMdsnDowv94g68WkJMzV9GRmorHNkTCEhA+LEa5Tu+29E2a25DKEo+SwloqLMOwFeeLvO4BMrhBtV...', hex)
    scriptHash = Buffer.from('2N5i5g68WRthk1mhkRfVxbHUvTSzFmkZ1KL')
